...
export function ProjectCard({ project, index }: ProjectCardProps) {
  ...
  const projectLabel = project.slug === 'kagoshima-travel' ? '실제 운영 화면' : '구현 증거';
  ...
  return (
    <article className={styles.card} data-project={project.slug} id={project.slug}>
      ...
      <Link
        className={`${styles.visual} ${isDiagram ? styles.diagramVisual : ''} ${hasVisualCollection ? styles.visualCollection : ''} ${isSingleVisualCollection ? styles.singleVisualCollection : ''}`}
